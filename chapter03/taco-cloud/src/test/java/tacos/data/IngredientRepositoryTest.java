...
public class IngredientRepositoryTest {
	...
	public void testFindOne() {
	    ...
	    assertEquals(expected, ingredientRepo.findOne(expected.getId()));
	}
	
	@Test
	public void testSave() {
		Ingredient expected = new Ingredient("TEST", "Test Ingredient", Ingredient.Type.WRAP);
		ingredientRepo.save(expected);
		assertEquals(expected, ingredientRepo.findOne(expected.getId()));
	}
